        ...
        <div className="recipeDetailInfo2" >
          ...
          <div className="table">
            <div className="row">
              ...
              <span className='col'>{INFO_ENG}</span>
            </div>
            <div className="row">
              <span className='col'>탄수화물 : </span>
              <span className='col'>{INFO_CAR}</span>
            </div>
            <div className="row">
              <span className='col'>단백질 : </span>
              <span className='col'>{INFO_PRO}</span>
            </div>
            <div className="row">
              <span className='col'>열량 : </span>
              <span className='col'>{INFO_ENG}</span>
            ...
            <div className="row">
              ...
              <span className='col'>{INFO_FAT}</span>
            </div>
            <div className="row">
              <span className='col'>나트륨 : </span>
              <span className='col'>{INFO_NA}</span>
            </div>
            <div className='tip'>
